...
const AddIncome = () => {
  ...
  const incomeCategories = categories.filter((c) => ["Salary", "Freelance", "Allowance"].includes(c.name));
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <Card>
        <CardHeader><CardTitle className="text-base flex items-center gap-2"><PlusCircle className="h-4 w-4 text-income" /> New Income</CardTitle></CardHeader>
        <CardContent>
